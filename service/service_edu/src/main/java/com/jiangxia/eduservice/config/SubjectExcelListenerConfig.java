...
/**
 * @author jiangxia
 * @date 2022年02月27日 20:01
 * desc：读取excel的监听器配置类
 */
public class SubjectExcelListenerConfig extends AnalysisEventListener<SubjectData> {
    //因为SubjectExcelListener不能交给spring进行管理，需要自己new，不能注入其他对象
    //不能实现数据库操作
    public EduSubjectService subjectService;
    public SubjectExcelListenerConfig() {}
    public SubjectExcelListenerConfig(EduSubjectService subjectService) {
